...
import 'episode_tvseries_page_test.mocks.dart';
...
void main() {
  ...
  testWidgets('Page should display center progress bar when loading',
    ...
    await tester.pumpWidget(_makeTestableWidget(EpisodeSeriesPage(season: 8, id: 1)));
  ...
  testWidgets('Page should display ListView when data is loaded',
    ...
    when(mockNotifier.tvseries).thenReturn(<TVSeriesEpisode>[]);
